...
#K.set_image_dim_ordering('tf')  # Theano dimension ordering in this code # dont work
# K.set_image_dim_ordering('th')  # Theano dimension ordering in this code # dont work
...
def get_model(X_train):
    model = Sequential()
    model.add(Convolution2D(32, 3, 3, border_mode='same',input_shape=(128,128,3))) # потом попробовать по-новому
    #model.add(Conv2D(32, (3, 3), input_shape=(128, 128,..., padding="same")))  # new keras call
